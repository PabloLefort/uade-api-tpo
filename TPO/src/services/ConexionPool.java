...
public class ConexionPool {
	...
	public static synchronized Connection newConexion() throws SQLException {
		...
		String labelPrefixNullConnection = ConexionPool.class + " newConexion: conexi�n NULL entregada en ";
		String labelPrefixConnection = ConexionPool.class + " newConexion: conexi�n entregada en ";
	...
	public static synchronized void closeConexion(Connection conexion) {
		...
		showPerformance(tiempoInicialNanoSegundos, ConexionPool.class + " closeConexion: conexi�n cerrada en");
	}
