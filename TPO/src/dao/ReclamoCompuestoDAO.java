...
public class ReclamoCompuestoDAO {
	...
	public void Save(Reclamo reclamo_compuesto, Reclamo reclamo)
			throws ConexionException, ReclamoException, AccesoException {
		Connection con = null;
		Statement stmt = null;
		ResultSet rs = null;
	...
	public ReclamoCompuesto GetById(int id)
			throws ConexionException, ReclamoException, AccesoException, ClienteException {
		Connection con = null;
		Statement stmt = null;
		ResultSet rs = null;
